...
public class ParkManagerTest {
    ...
    @Test(expected = main.java.homework.NoCarException.class)
    ...
    @Test(expected = main.java.homework.ParkFullException.class)
    ...
    public void parkManager_include_self_sub_parkBoy_ShouldParkCar()
    {
        ...
        for(ParkBoyInfo parkBoyPerson:parkBoys)
        {
            ...
            Ticket ticket = parkBoy.park(car);
            System.out.println((index+1)+"銆�"+(integers[index].intValue()-1)+":"+parkBoy.getAvailableNum());
